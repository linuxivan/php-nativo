...
<body>
    ...
    <div id="cuerpo">
        ...
        <form action="updateJuego.php" method="post">
            ...
            <?php
                echo "<input type='text' id='titulo' name='titulo' value='".$juego["titulo"]."'/><br>";
                echo "<input type='hidden' id='id' name='id' value='".$juego["id"]."'/>"
            ?>
            ...
            <input type="text" name="precio" id="precio" value='<?php echo $juego["precio"];?>'/><br>
            <label for="imagen">Imagen</label>
            <?php
                $imagen = $juego["imagen"];
                echo "<input type='text' name='imagen' id='imagen' value='$imagen'/><br>";
            ?>
            ...
            <select id="genero" name="genero">
                <?php
                    ...
                    {
                        if($generos[$i]["id"] == $juego["id_genero"])
                        {
                            echo "<option value='".$generos[$i]["id"]."' selected='true'>".$generos[$i]["nombre"]."</option>";
                        } else
                        {
